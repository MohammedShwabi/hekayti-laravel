                ...
                <form method="get" action="{{ route('manage') }}">
                    <div class="search form-group">
                        ...
                        <input type="text" value="{{ $search }}" name="search" id="search_txt"
                            ...
                            class="form-control shadow-none" placeholder="بحث عن مدير ...">
                        ...
                        <div class="list-content py-4 pe-4 mt-4 mb-3" id="list_content">
                            <div class="row justify-content-center align-items-center text-center">
                                ...
                                <div class="col-lg-3 user-pros">
                                    ...
                                    <a class="delete_popup text-decoration-none" id="delete_popup"
                                        onclick="deletePopup({{ $admin->id }},'delete_manager','admin_id')">
                    ...
                    <div class="modal-body  mx-5 mb-4">
                        ...
                        <div class="form-group">
                            <div class="col-12 mt-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="username" id="usernameInput" required
                                    placeholder="محمد شوابي" autofocus>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="email" class="form-control" name="email" id="emailInput" required
                                placeholder="exsample@gmil.com" value="{{ old('email') }}">
                        ...
                        <div class="col-12">
                            <label for="password_confirmationInput" class="form-label manager-confirm-pass">تأكيد كلمة
                                المرور</label>
                    ...
                    <div class="modal-body  mx-5 mb-4">
                        ...
                        <div class="form-group">
                            <div class="col-12 mt-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="username" id="usernameEditInput"
                                    required placeholder="محمد شوابي" autofocus>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="password" class="form-control" name="password" id="passwordEditInput"
                                autocomplete="new-password" placeholder="اترك الحقل فارغا اذا لم ترد التعديل">
                        ...
                        <div class="col-12">
                            <label for="password_confirmationEditInput" class="form-label manager-confirm-pass">تأكيد كلمة
                                المرور
                            </label>
                            <input type="password" class="form-control" name="password_confirmation"
                                id="password_confirmationEditInput" placeholder="تأكيد كلمة المرور الجديدة"
                                autocomplete="new-password">
